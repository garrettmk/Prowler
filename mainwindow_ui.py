...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/amazon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon2.addPixmap(QtGui.QPixmap("icons/ops_view.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
